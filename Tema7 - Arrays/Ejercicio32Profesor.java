...
public class Ejercicio32Profesor {
    public static final int SIZE = 4; // Tamaño del tablero
    ...
    public static void main(String[] args) {
        ...
        while (!victoria && !terminado) {
            if (turno == 0) { // Juega el ordenador
                ...
                do {
                    System.out.print("Introduzca coordenada vertical (a-d): ");
                    ...
                    System.out.print("Introduzca coordenada horizontal (0-3): ");
                    columna = sc.nextInt();
                    sc.nextLine();
                } while (!posicionValida(tablero, fila, columna));
